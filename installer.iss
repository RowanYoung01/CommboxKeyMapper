#define AppName     "ACU-624D Key Mapper"
#define AppExe      "ACU624KeyMapper.exe"
...
DefaultDirName={localappdata}\ACU624KeyMapper
DisableDirPage=yes
DefaultGroupName={#AppName}
OutputDir=installer_output
OutputBaseFilename=ACU624KeyMapper_Setup
...
Root: HKCU; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Run"; \
    ValueType: string; ValueName: "ACU624KeyMapper"; \
...
Filename: "powershell.exe"; \
    Parameters: "-Command ""Stop-Process -Name ACU624KeyMapper -Force -ErrorAction SilentlyContinue"""; \
    RunOnceId: "StopProcess"; Flags: runhidden

[UninstallDelete]
; Clean up the settings file left next to the EXE
Type: files; Name: "{app}\ACU624KeyMapper.json"
